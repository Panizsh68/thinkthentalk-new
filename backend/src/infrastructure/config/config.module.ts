  ...
  imports: [
    ConfigModule.forRoot({
      ...
      validationSchema: Joi.object({
        ...
        IPPANEL_PATTERN_BASE_URL: Joi.string().uri().optional(),
        ...
        IPPANEL_OTP_PATTERN_CODE: Joi.string().default('2tc60'),
        IPPANEL_REGISTER_EVENT_PATTERN_CODE: Joi.string().default('kc0p2'),
