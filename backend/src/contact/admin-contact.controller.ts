...
import { PaginatedContactMessagesDto, ContactMessageDto } from './dto/contact-message.dto';
...
export class AdminContactController {
  ...
  async list(@Query() query: ListContactMessagesQueryDto): Promise<PaginatedContactMessagesDto> {
  ...
  @ApiOkResponse({ type: ContactMessageDto })
  @ApiBadRequestResponse({ description: 'Invalid status.', type: ErrorResponseDto })
  @ApiUnauthorizedResponse({ description: 'Not authenticated.', type: ErrorResponseDto })
  @ApiForbiddenResponse({ description: 'Forbidden.', type: ErrorResponseDto })
  async updateStatus(
    @Param('id') id: string,
